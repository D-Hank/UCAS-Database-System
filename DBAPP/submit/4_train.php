...
$drop2 = "DROP VIEW train_4_ticket";
pg_query($drop2);
pg_query($drop);
pg_query($view);

$view2 = 
"CREATE view train_4_ticket AS
SELECT
	t.t_id AS ticket_id,
	t.t_which_seat AS which_seat,
	'{$INPUT_train_num}' AS train_num,
	date '{$INPUT_ddate}' AS ddate,
	sc3.sc_depart_time AS depart_time,
	ts._rank AS _rank,
	ts.station AS station,
	sc3.sc_arrive_time AS arrive_time,
	sc3.sc_total_time AS total_time,
